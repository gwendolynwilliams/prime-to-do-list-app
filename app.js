...
//var routes = require('./routes/routes'); // routes left in this file
...
//app.use('/routes', routes); //routes left in this file

app.set('port', process.env.PORT || 5000);

//app.use(app.router); //tried using this for data route - it broke the database - ended up leaving my data routes in this file
